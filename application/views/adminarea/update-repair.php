        ...
        <form role="form" action="<?= base_url('Adminarea/repair'); ?>" method="post" enctype="multipart/form-data">
         ...
         <div class="form-group row">
           <label class="col-sm-2 col-form-label">Customer Name</label>
            ...
            <label class="col-sm-2 col-form-label">Repair Intake Form Date</label>
             <div class="col-sm-4">
            ...
            <div class="form-group row">
             ...
             <div class="col-sm-4">
              <input type="text" class="form-control" name="date_comp">
            </div>
            </div>
          </div>
